...
import com.mlg.myapplication.ui.theme.MyApplicationTheme
...
//                Text(text = name)
//            }
//            ElevatedButton(onClick = { // in on click we will toggle if false make true and opposite
//                expanded.value = !expanded.value
//            }) {
//                Text(if (expanded.value) "Show Less" else "Show More") //if expand.value = false collapse else show more
//            }
//        }
//    }
}
